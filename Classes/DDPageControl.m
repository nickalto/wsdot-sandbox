...
- (void)drawRect:(CGRect)rect 
{
	...
	CGFloat diameter = kDotDiameter;//(indicatorDiameter > 0) ? indicatorDiameter : kDotDiameter ;
	...
	UIColor *drawOnColor = onColor ? onColor : [UIColor colorWithRed:0.416 green:0.639 blue:0.576 alpha:1.000];//[UIColor colorWithWhite: 1.0f alpha: 1.0f];
	UIColor *drawOffColor = [UIColor colorWithRed:0.129 green:0.129 blue:0.133 alpha:1.000];
